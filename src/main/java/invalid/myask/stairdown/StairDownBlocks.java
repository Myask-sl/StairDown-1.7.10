...
public class StairDownBlocks {
    ...
    public static void registerASlab(String s, int metaMin, int metaMax) {
        ...
        registerABlockAlter(bs, s, ".slab." + metaMin + ".." + metaMax, ItemSlabFromParent.class, b, bs, bds, false);
        registerABlockAlter(bds, s, ".doubleSlab." + metaMin + ".." + metaMax, ItemSlabFromParent.class, b, bs, bds, true);
        MADE_SLABS.add(bs);
        MADE_SLABS.add(bds);
    }
}
