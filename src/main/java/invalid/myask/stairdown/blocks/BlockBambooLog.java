...
public class BlockBambooLog extends BlockLog {
    ...
    public void registerBlockIcons(IIconRegister reg) {
        ...
        for (int i = 0; i < TEXTURE_SUB_NAMES.length; i++) {
            this.field_150167_a[i] = reg
                .registerIcon(StairDown.MODID + ":" + this.getTextureName() + "_" + TEXTURE_SUB_NAMES[i]);
            this.field_150166_b[i] = reg
                .registerIcon(StairDown.MODID + ":" + this.getTextureName() + "_" + TEXTURE_SUB_NAMES[i] + "_top");
        }
    }
}
