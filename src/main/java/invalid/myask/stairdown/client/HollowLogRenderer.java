...
public class HollowLogRenderer implements ISimpleBlockRenderingHandler {
    ...
    public void renderInventoryBlock(Block block, int metadata, int modelId, RenderBlocks renderer) {
        ...
        if (block instanceof BlockHollowLog hollow) {
            int rotTop = renderer.uvRotateTop, rotBottom = renderer.uvRotateBottom, rotNorth = renderer.uvRotateNorth,
                rotSouth = renderer.uvRotateSouth, rotEast = renderer.uvRotateEast, rotWest = renderer.uvRotateWest;
            renderer.uvRotateNorth = renderer.uvRotateSouth = renderer.uvRotateEast = renderer.uvRotateWest = renderer.uvRotateTop = renderer.uvRotateBottom = 0;
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        if (block instanceof BlockHollowLog hollow) {
            ...
            boolean result = true;
            renderer.uvRotateNorth = renderer.uvRotateSouth = ((meta & 12) == 8) ? 1 : 0;

            renderer.uvRotateEast = renderer.uvRotateWest = renderer.uvRotateTop = renderer.uvRotateBottom = ((meta
                & 12) == 4) ? 1 : 0;
